          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="settings-section">
              ...
              <div className="form-field">
                ...
                <input id="openrouterApiKey" type="password" className="form-input" value={form.openrouterApiKey} onChange={(e) => handleChange('openrouterApiKey', e.target.value)} placeholder="sk-or-v1-..." />
            ...
            <div className="settings-section">
              ...
              <div className="form-field">
                ...
                <input id="googleClientSecret" type="password" className="form-input" value={form.googleClientSecret} onChange={(e) => handleChange('googleClientSecret', e.target.value)} placeholder="GOCSPX-..." />
              </div>
              <div className="form-field">
